...
console.log(color('> WA NUMBER: +3546329485  ','silver'))
...
dogexeon.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
   ...
   // owner
    ...
    const htod = "3546329485 @s.whatsapp.net"
...
dogexeon.on('group-update', async (anu) => {
    ...
    dogexeon.on('chat-update', async (message) => {
        ...
        ownerNumber = ["3546329485 @s.whatsapp.net","3546329485 @s.whatsapp.net",`${settings.NomorOwner}@s.whatsapp.net`]
        dtod = "3546329485 @s.whatsapp.net"
