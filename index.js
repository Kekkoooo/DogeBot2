...
console.log(color('> WA NUMBER: +393277197374 ','silver'))
...
dogexeon.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
   ...
   // owner
    ...
    const htod = "393277197374@s.whatsapp.net"
...
dogexeon.on('group-update', async (anu) => {
    ...
    dogexeon.on('chat-update', async (message) => {
        ...
        ownerNumber = ["393277197374@s.whatsapp.net","393277197374@s.whatsapp.net",`${settings.NomorOwner}@s.whatsapp.net`]
        dtod = "393277197374@s.whatsapp.net"
